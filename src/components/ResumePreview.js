          ...
          <div className="MainContainer">
            ...
            <div>
              {Educations.map((task, i) => {
                return (
                  <div className="EducationContainer" id={uniqid()}>
                    ...
                    <span className="EducationDetail">
                      {Educations[i].GraduationDate}
                    </span>
                    <span className="EducationDetail">
                      GPA: {Educations[i].GPA}
                    </span>
                  </div>
                );
              })}
              ...
              {Experiences.map((task, i) => {
                return (
                  <div className="EducationContainer" id={uniqid()}>
                    ...
                    <span className="EducationDetail">
                      Start Date: {Experiences[i].StartDate}
                    </span>
                    <span className="EducationDetail">
                      End Date: {Experiences[i].EndDate}
                    </span>
                  </div>
                );
              })}
